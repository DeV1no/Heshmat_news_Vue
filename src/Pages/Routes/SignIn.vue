<template>
  <form class="main-bg" @submit.prevent="submitForm">
    <div class="login-container text-c animated flipInX">
      ...
      <h3 class="text-whitesmoke">فرم ورود</h3>
      <div class="container-content">
        <form class="margin-t">
          ...
          <p v-if="!formIsValid" class="text-danger">
            خطا: لطفا پارامترای ورودی را چک کنید
          </p>
          <a class="text-darkyellow" href="#"
            ><small>فراموشی رمز عبور</small></a
          >
          <p class="text-whitesmoke text-center">
            <small>حساب کاربری ندارید؟</small>
          </p>
          <router-link to="/SignUp" class="text-darkyellow"
...
export default {
  ...
  methods: {
    ...
    switchAuthMode() {
      ...
      //  await if (this.$store.state.auth.isAuth) {
      //   this.$router.replace('/');
      // }
    }
  }
